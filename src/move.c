...
void move_player_y(t_data *data,int dir){
	if(data->map_arr[data->pos_y + dir][data->pos_x] != '1' && (data->map_arr[data->pos_y + dir][data->pos_x] != 'E')){
		mlx_put_image_to_window(data->mlx, data->win, data->img->background,
			(data->pos_x * CELL_W), (data->pos_y * CELL_H));
		data->pos_y += dir;
	...
	else if(data->map_arr[data->pos_y + dir][data->pos_x] == 'E' && data->item_count != data->item_total)
...
void move_player_x(t_data *data,int dir){
	if(data->map_arr[data->pos_y][data->pos_x + dir] != '1' && (data->map_arr[data->pos_y][data->pos_x + dir] != 'E')){
		mlx_put_image_to_window(data->mlx, data->win, data->img->background,
			(data->pos_x * CELL_W), (data->pos_y * CELL_H));
		data->pos_x += dir;
		mlx_put_image_to_window(data->mlx, data->win, data->img->player,
	...
	else if(data->map_arr[data->pos_y][data->pos_x + dir] == 'E' && data->item_count != data->item_total)
		ft_putstr_fd("!Collect them all to clear the game!\n",1);
	else if(data->map_arr[data->pos_y][data->pos_x + dir] == 'E' && data->item_count == data->item_total)
			close_game(data);
}
